...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
				...
				|| findKeyword(statement, "brother") >= 0)
		{
			response = "Tell me more about your family.";
				...
				|| findKeyword(statement, "donut") >= 0
				|| findKeyword(statement, "burrito") >= 0)
		{
			response = "Tell me more abour your favorite foods";
		}
		else if (findKeyword(statement, "california") >= 0
				|| findKeyword(statement, "san diego") >= 0)
		{
			response = "Tell me more about where you live";
		}
				...
				|| findKeyword(statement, "Mauro") >= 0)
		{
			response = "He is an awesome teacher!";
				...
				|| findKeyword(statement, "book") >= 0
				|| findKeyword(statement, "TV") >= 0)
		{
			response = "Tell me more about what you like to do";
		}
	...
	private String transformIWantStatement(String x) {
		if (x.indexOf("I want something")>=0) {
